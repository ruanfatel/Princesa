...
(() => {
  ...
  /* ------------------------------------------------------------------ *
   * PWA — registra o service worker (necessário para o site poder ser
   * "instalado" como app / convertido em APK por ferramentas como o
   * PWABuilder). Funciona só em produção (https ou localhost).
   * ------------------------------------------------------------------ */
